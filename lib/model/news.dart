...
class News {
  ...
  String is_home_banner;
	...
	@override
	String toString() {
		return 'News{id: $id, title: $title, content: $content, image: $image, link: $link, video_link: $video_link, created_date: $created_date, updated_date: $updated_date, is_home_banner: $is_home_banner}';
	}
